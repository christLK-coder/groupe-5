...
try {
    ...
    $pdf->MultiCell(0, 6, "Date du rendez-vous: " . date('d/m/Y H:i', strtotime($consultation['date_debut'])), 0, 'L');
    ...
    $body = "Veuillez trouver ci-joint votre rapport de consultation réalisé le " . date('d/m/Y', strtotime($consultation['date_debut'])) . ".";
