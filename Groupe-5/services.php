...
<head>
    ...
    <style>
        ...
        /* --- Conteneur des Services (services.php) --- */
        .services-container {
            padding: 40px 20px;
            max-width: 1200px;
            margin: 0 auto;
        ...
        .service-box {
            ...
            height: 100%; /* Important pour que les box aient la même hauteur */
        }
        ...
        .service-image {
            width: 100%;
            height: 180px; /* Hauteur fixe pour les images de service */
            object-fit: cover;
        ...
        @media (max-width: 768px) {
            ...
            .service-grid {
                /* On smaller screens, go back to 2 columns or 1 */
...
<body>
    ...
    <main class="services-container">
        ...
        <div class="service-grid">
            <?php
            try {
                // Select nom_service instead of specialite from SERVICES table
                ...
                if ($stmt->rowCount() > 0) {
                    while ($service = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        $image_service = $service['image_service'] ?? 'default_service.jpg'; // Default image if NULL
