...
// Démarre la session pour vérifier la connexion du patient
session_start();

// Vérifie si un patient est connecté
...
// Récupérer les informations du médecin et de sa spécialité
try {
    $stmt_medecin = $pdo->prepare("
        ...
        WHERE
            M.id_medecin = ?
        GROUP BY M.id_medecin -- Groupez par médecin pour obtenir une note moyenne unique
    ");
    ...
    // Assignation des valeurs, avec des valeurs par défaut si NULL
    ...
    $average_rating = $medecin['average_rating'] ? number_format($medecin['average_rating'], 1) : 'N/A'; // Formater à 1 décimale, ou N/A
...
<head>
    ...
    <style>
        ...
        .profile-image-circle {
            ...
            margin-top: -45px; /* Pulls image up into the header */
        ...
        .profile-body {
            padding: 30px;
            display: flex; /* Arrange sections side-by-side on larger screens */
            gap: 30px;
        }
...
<body>
    <div class="profile-container">
        ...
        <img src="<?php echo $medecin_image; ?>" alt="Photo du Dr. <?php echo $medecin_prenom . ' ' . $medecin_nom; ?>" class="profile-image-circle">
        ...
        <div class="chat-button-container">
            ...
            <?php else: ?>
                ...
                <a href="login.php" class="chat-button" style="background-color: #f39c12;">
                    Se connecter
                </a>
            <?php endif; ?>
        </div>
