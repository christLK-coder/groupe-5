<?php
require_once 'connexion.php'; // Ensure this path is correct
...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $update = $pdo->prepare("UPDATE specialite SET nom = ?, description_specialite = ?, id_service = ? WHERE id_specialite = ?");
